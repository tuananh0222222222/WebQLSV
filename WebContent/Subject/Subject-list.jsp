              ...
              <%@include file="../Template/Header.jsp" %>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="Subject-add.jsp" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                ...
                                <tbody>
                                	<%for(Subjects item : SubjectsDAO.getSubject()){
	                                	...
	                                	<tr>
	                                        ...
	                                        <td> 
	                                        <a href="Subject-edit.jsp?Id=<%=item.getId() %>" class=" btn btn-primary">Chi tiết</a>
